...
@Schema(
        name = "Customer",
        description = "Customer to hold Account and Customer level information"
)
public class CustomerDto {
    ...
    //we are sending aggrigated information of account within customer dta we have two options to declare one more class
